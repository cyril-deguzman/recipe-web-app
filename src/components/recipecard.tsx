 ...
 *
 * @param {Recipe} recipe the recipe metadata
...
export function RecipeCard({ recipe }: { recipe: RecipeMetadata }) {
  ...
  return (
    <Card className="w-[90%] mx-auto md:w-[45%] lg:w-[23%] lg:mx-0">
      <CardContent className="p-0 pt-6 px-6 pb-2">
      ...
      <CardFooter className="flex flex-wrap pt-0 pb-4">
        <div className="w-[100%] pb-1">
          <p className="text-center text-lg font-medium truncate">
            {recipe.name}
          </p>
        </div>
